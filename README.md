...
Hasil pengujian yang diperoleh menggunakan metode confusion matrix pada model yang dibuat menggunakan algoritma Support Vector Machine memberikan hasil nilai accuracy 77%, precission 78%, recall 91%, dan F1-SCORE 84%.
